...
@section('contentGuest')
    <div class="bg-white text-center border shadow rounded-3 p-5 mt-5">
        <main class="form-signin rounded">
            <form action="{{ route('register') }}?role={{ $role }}" method="POST">
                ...
                @endif
                <div class="form-floating mb-2">
                    <input type="text"  name="phone" class="form-control form-input-color @error('phone')is-invalid @enderror" value="{{old('phone')}}" id="phone" placeholder="ex: 081312122161..." required>
                ...
                <div class="form-floating mb-2">
                    <input type="email"  name="email" class="form-control form-input-color @error('email')is-invalid @enderror" value="{{old('email')}}" id="email"placeholder="ex: johndoe@gmail.com..." required>
                ...
                <div class="form-floating mb-2">
                    <input type="password" name="password" class="form-control form-input-color @error('password')is-invalid @enderror" id="password" placeholder="Password" required>
                ...
                <div class="form-floating">
                    <input type="password" name="password_confirmation" class="form-control form-input-color @error('password_confirmation')is-invalid @enderror rounded-bottom" id="password_confirmation" placeholder="type password again here..." required>
