...
@section('content')
    ...
    <div class="row g-2">
        ...
        <div class="col-md-9">
            <div class="card bg-white m-lg-2 rounded">
                <div class="card-body">
        ...
        $(document).ready(function() {
            ...
            var calendar = $('#calendar').fullCalendar({
                ...
                select: function(start, end, allDay) {
                    ...
                    let m = ((start.getMonth() + 1) < 10) ? '0' + (start.getMonth() + 1) : (start
                        .getMonth() + 1);
                    let doc = document.getElementById('showSchedules' + start.getFullYear() + '-' + m +
                        '-' + d);
                    if (doc) {
