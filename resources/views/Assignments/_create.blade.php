            ...
            <form action="{{route('course.assignments.store',$course)}}" method="POST"  enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" value="{{$class->name}}" class="form-control" disabled>
                        <input type="text" name="class" value="{{$class->id}}" placeholder="test" class="form-control" id="class" hidden>
                    </div>
                </div>
